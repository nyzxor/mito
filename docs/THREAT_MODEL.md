...
Status: Phase 0 draft. Companion to `DESIGN.md`. Every mitigation named here must map to a test
in `handbrake/tests/` or `evals/safety/` before the corresponding phase closes.
